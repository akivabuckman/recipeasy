        ...
        <div className="w-20">
          {baseDetail.count != null && (
            <input
              ...
              min={0}
              step="any"
              className="w-full bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-700 rounded px-2 py-1 text-base text-right text-zinc-900 dark:text-white focus:outline-none focus:border-zinc-400 dark:focus:border-zinc-500"
            />
          )}
        </div>
